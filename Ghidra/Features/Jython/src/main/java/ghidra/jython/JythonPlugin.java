...
public class JythonPlugin extends ProgramPlugin
	...
	private void welcome() {
		...
		out.println("═══════════════════════════════════════════════════════════");
		out.println("  Binhunters Interactive Python Console");
		out.println("  Based on Jython " + PySystemState.version);
		out.println("═══════════════════════════════════════════════════════════");
		out.println();
		out.println("  Available variables:");
		out.println("    currentProgram   - The currently open program");
		out.println("    currentAddress   - Address at the cursor position");
		out.println("    currentSelection - Current selection in the listing");
		out.println("    currentHighlight - Current highlight in the listing");
		out.println("    monitor          - Task monitor for progress/cancel");
		out.println("    state            - Current plugin tool state");
		out.println();
		out.println("  Quick examples:");
		out.println("    currentProgram.getName()");
		out.println("    getFunctionAt(currentAddress)");
		out.println("    getDataAt(currentAddress)");
		out.println("    currentProgram.getFunctionManager().getFunctionCount()");
		out.println("    list(currentProgram.getSymbolTable().getExternalSymbols())");
		out.println();
		out.println("  Type help(object) for API details, dir(object) to list members");
		out.println("  Press 'F1' for full usage instructions");
		out.println("═══════════════════════════════════════════════════════════");
		out.println();
	}
