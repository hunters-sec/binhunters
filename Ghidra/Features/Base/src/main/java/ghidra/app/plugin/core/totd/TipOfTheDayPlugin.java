...
public class TipOfTheDayPlugin extends Plugin implements ApplicationLevelOnlyPlugin {
	...
	private void readPreferences() {
		...
		// Binhunters: Tips are disabled by default — moved to Documentation panel.
		// Force-migrate any saved SHOW_TIPS=true from previous installs to false.
		String showTipsStr = Preferences.getProperty(SHOW_TIPS, "false", true);
		if ("true".equals(showTipsStr)) {
			showTipsStr = "false";
			Preferences.setProperty(SHOW_TIPS, "false");
			Preferences.store();
		}
