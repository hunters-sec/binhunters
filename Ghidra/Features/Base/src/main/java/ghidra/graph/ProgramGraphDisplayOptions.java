...
public class ProgramGraphDisplayOptions extends GraphDisplayOptions {
	...
	protected void initializeDefaults() {
		...
		// Enable edge labels for block/code flow graphs
		setEdgeLabelOverrideAttributeKey("EdgeLabel");

		// Binhunters: increase max graph nodes for large functions
		setMaxNodeCount(2000);
		//@formatter:on
	}
}
