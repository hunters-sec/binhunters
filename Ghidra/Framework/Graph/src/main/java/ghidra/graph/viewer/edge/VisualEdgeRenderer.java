...
public abstract class VisualEdgeRenderer<V extends VisualVertex, E extends VisualEdge<V>>
	...
	/**
	 * Returns the base stroke used to draw the edge shape. Subclasses can override
	 * this to provide different strokes based on edge properties (e.g., flow type).
	 * The default implementation returns a standard 1.0f solid stroke.
	 *
	 * @param e the edge being rendered
	 * @return the stroke to use for the base edge rendering
	 */
	protected Stroke getBaseStroke(E e) {
	...
	public void drawSimpleEdge(RenderContext<V, E> rc, Layout<V, E> layout, E e) {
		...
		// basic shape - use subclass-provided stroke for flow-type differentiation
		Stroke baseStroke = getBaseStroke(e);
